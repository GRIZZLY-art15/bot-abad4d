...
def load_config():
    try:
        ...
        return {"welcome_message": "🌟 SELAMAT DATANG DI ABAD4D OFFICIAL 🌟", "website_url": "https://siteq.link/kajian4d"}
...
def admin_login():
    if request.method == 'POST':
        ...
        if password_hash == ADMIN_PASSWORD_HASH:
            ...
            <!DOCTYPE html>
            <html>
            <head><title>Login - ABAD4D Admin</title>
            <style>
...
def admin_panel():
    ...
    <head>
        ...
        <title>Admin Panel - ABAD4D Bot</title>
        <style>
...
if __name__ == "__main__":
    print("=" * 60)
    print("🤖 ABAD4D BOT TELEGRAM - DENGAN BROADCAST OTOMATIS")
    print("=" * 60)
    ...
    print("👑 Admin Panel: /admin (password: Abad4D225511)")
